...
<a href="{{route('subscriptions.create')}}" class=" btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add new Plan</a><br>
 			 ...
 			 <div class="box-body">
 			 	<table id="example2" class="table table-hover dataTable table-striped no-footer no-border">
 			 		...
 			 		<tbody>
                            ...
                            <td>{{$plan->price}}</td>
                            <td>{{$plan->duration}}</td>
                            <td>{{$plan->max_stock}}</td>

                            <td>
                                <a href="{{route('subscriptions.edit',$plan->id)}}" class="label label-primary " style="margin-left: 5px;"><i class="fa fa-edit fa-1x"></i> </a>
